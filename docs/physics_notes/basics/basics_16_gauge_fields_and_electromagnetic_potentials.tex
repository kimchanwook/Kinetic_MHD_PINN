...
\item Magnetic flux.
\item Potentials in particle dynamics.
...
\item \textbf{Chapter 1: Scalar potential.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Vector potential.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Gauge freedom.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Canonical momentum.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Magnetic flux.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Potentials in particle dynamics.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_16_gauge_fields_and_electromagnetic_potentials.tex}\\
\path{basics_16_gauge_fields_and_electromagnetic_potentials.pdf}
\end{center}
