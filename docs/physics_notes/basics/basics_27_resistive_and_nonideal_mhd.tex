...
\rhead{Basics 27 Course Note}

\begin{document}
\DocTitle{Basics 27: Resistive and Nonideal MHD}{IV - Magnetohydrodynamics}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}

\begin{overviewbox}
\textbf{Curriculum scaffold - not yet a completed textbook chapter.} This file reserves the scope, learning sequence, and advanced-module connections for Basics 27. The completed version will begin from first principles, derive its central equations, include physical intuition and worked examples, and connect each derivation to numerical implementation. No placeholder statement in this scaffold should be cited as a finished derivation.
\end{overviewbox}

\ProjectTOC

\section{Role in the curriculum}
This note belongs to \textbf{IV - Magnetohydrodynamics}. Its purpose is to make the later simulation modules readable to a student who has no prior plasma-physics background. The principal downstream connections are: \textbf{Modules 1, 4, 5, and 8}.

\section{Learning objectives}
After the completed note is written and studied, a reader should be able to:
\begin{itemize}[leftmargin=1.6em]
\item Resistivity.
\item Magnetic diffusion.
\item Reconnection.
\item Hall term.
\item Electron pressure.
\item Electron inertia.
\item Generalized ohm law.
\item Regime ordering.
...
\item \textbf{Chapter 1: Resistivity.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Magnetic diffusion.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Reconnection.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Hall term.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Electron pressure.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Electron inertia.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Generalized ohm law.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 8: Regime ordering.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_27_resistive_and_nonideal_mhd.tex}\\
\path{basics_27_resistive_and_nonideal_mhd.pdf}
\end{center}
