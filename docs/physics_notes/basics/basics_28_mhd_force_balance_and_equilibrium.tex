...
\item J-cross-b force.
\item Pressure balance.
\item Force-free fields.
\item Magnetic surfaces.
\item Grad-shafranov concepts.
\item Three-dimensional equilibrium.
...
\item \textbf{Chapter 1: Static equilibrium.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: J-cross-b force.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Pressure balance.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Force-free fields.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Magnetic surfaces.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Grad-shafranov concepts.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Three-dimensional equilibrium.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_28_mhd_force_balance_and_equilibrium.tex}\\
\path{basics_28_mhd_force_balance_and_equilibrium.pdf}
\end{center}
