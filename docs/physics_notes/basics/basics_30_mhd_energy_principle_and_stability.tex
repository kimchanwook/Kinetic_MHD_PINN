...
\item Plasma displacement.
\item Perturbed kinetic energy.
\item Perturbed potential energy.
\item Stable and unstable variations.
\item Ideal-mhd stability.
\item Eigenmode interpretation.
...
\item \textbf{Chapter 1: Plasma displacement.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Perturbed kinetic energy.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Perturbed potential energy.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Stable and unstable variations.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Ideal-mhd stability.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Eigenmode interpretation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_30_mhd_energy_principle_and_stability.tex}\\
\path{basics_30_mhd_energy_principle_and_stability.pdf}
\end{center}
