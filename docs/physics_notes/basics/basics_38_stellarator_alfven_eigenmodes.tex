...
\item Three-dimensional harmonic coupling.
\item Helical gaps.
\item Ellipticity-induced gaps.
\item Noncircular gaps.
\item Hae.
\item Eae.
\item Nae.
\item Stellarator-specific spectra.
...
\item \textbf{Chapter 1: Three-dimensional harmonic coupling.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Helical gaps.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Ellipticity-induced gaps.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Noncircular gaps.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Hae.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Eae.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Nae.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 8: Stellarator-specific spectra.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_38_stellarator_alfven_eigenmodes.tex}\\
\path{basics_38_stellarator_alfven_eigenmodes.pdf}
\end{center}
