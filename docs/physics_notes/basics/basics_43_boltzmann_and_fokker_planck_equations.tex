...
\item Collision integrals.
\item Binary collisions.
\item Drag.
\item Diffusion in velocity space.
\item Fokker-planck approximation.
\item Slowing down.
...
\item \textbf{Chapter 1: Collision integrals.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Binary collisions.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Drag.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Diffusion in velocity space.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Fokker-planck approximation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Slowing down.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Pitch-angle scattering.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_43_boltzmann_and_fokker_planck_equations.tex}\\
\path{basics_43_boltzmann_and_fokker_planck_equations.pdf}
\end{center}
