...
\item Polarization drift.
\item Diamagnetic drift.
\item Charge and energy dependence.
...
\item \textbf{Chapter 1: E-cross-b drift.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Grad-b drift.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Curvature drift.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Polarization drift.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Diamagnetic drift.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Charge and energy dependence.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_45_particle_drifts_in_nonuniform_fields.tex}\\
\path{basics_45_particle_drifts_in_nonuniform_fields.pdf}
\end{center}
