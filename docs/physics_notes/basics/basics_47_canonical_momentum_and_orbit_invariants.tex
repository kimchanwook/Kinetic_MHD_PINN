...
\item Energy invariant.
\item Magnetic moment.
\item Canonical toroidal momentum.
\item Axisymmetry.
\item Three-dimensional symmetry breaking.
...
\item \textbf{Chapter 1: Lagrangian mechanics.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Canonical momentum.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Energy invariant.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Magnetic moment.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Canonical toroidal momentum.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Axisymmetry.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Three-dimensional symmetry breaking.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_47_canonical_momentum_and_orbit_invariants.tex}\\
\path{basics_47_canonical_momentum_and_orbit_invariants.pdf}
\end{center}
