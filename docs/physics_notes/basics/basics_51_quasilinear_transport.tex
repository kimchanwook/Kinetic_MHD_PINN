...
\item Resonant diffusion.
\item Random phases.
\item Phase averaging.
\item Diffusion tensors.
\item Profile flattening.
\item Saturation models.
\item Limitations.
...
\item \textbf{Chapter 1: Resonant diffusion.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Random phases.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Phase averaging.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Diffusion tensors.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Profile flattening.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Saturation models.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_51_quasilinear_transport.tex}\\
\path{basics_51_quasilinear_transport.pdf}
\end{center}
