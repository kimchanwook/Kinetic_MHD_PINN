...
\item Cross-section averaging.
\item Maxwellian reactivity.
\item Volumetric reaction rates.
\item Temperature dependence.
\item Fusion-power density.
...
\item \textbf{Chapter 1: Relative velocity.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Cross-section averaging.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Maxwellian reactivity.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Volumetric reaction rates.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Temperature dependence.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Fusion-power density.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_53_fusion_reactivity_and_reaction_rates.tex}\\
\path{basics_53_fusion_reactivity_and_reaction_rates.pdf}
\end{center}
