...
\item Energy confinement time.
\item Triple product.
\item Radiation losses.
\item Auxiliary heating.
\item Ignition.
\item Fusion gain.
\item Steady power balance.
...
\item \textbf{Chapter 1: Energy confinement time.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Triple product.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Radiation losses.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Auxiliary heating.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Ignition.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Fusion gain.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Steady power balance.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_56_lawson_criterion_and_fusion_power_balance.tex}\\
\path{basics_56_lawson_criterion_and_fusion_power_balance.pdf}
\end{center}
