...
\item Prompt loss.
\item Orbit loss.
\item Stochastic loss.
\item Resonant loss.
\item Wall strike maps.
\item Power density.
\item Material implications.
...
\item \textbf{Chapter 1: Prompt loss.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Orbit loss.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Stochastic loss.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Resonant loss.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Wall strike maps.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Power density.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Material implications.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_58_fast_ion_losses_and_wall_heat_loads.tex}\\
\path{basics_58_fast_ion_losses_and_wall_heat_loads.pdf}
\end{center}
