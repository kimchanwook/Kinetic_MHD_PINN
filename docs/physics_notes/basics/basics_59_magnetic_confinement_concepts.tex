...
\item Charged-particle confinement.
\item Open and closed field lines.
\item Toroidal confinement.
\item Radial transport.
\item Magnetic surfaces.
\item Loss mechanisms.
...
\item \textbf{Chapter 1: Charged-particle confinement.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Open and closed field lines.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Toroidal confinement.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Radial transport.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\item \textbf{Chapter 6: Loss mechanisms.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_59_magnetic_confinement_concepts.tex}\\
\path{basics_59_magnetic_confinement_concepts.pdf}
\end{center}
