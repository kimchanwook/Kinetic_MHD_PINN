...
\rhead{Basics 61 Course Note}

\begin{document}
\DocTitle{Basics 61: Toroidal Coordinates and Magnetic Surfaces}{VIII - Stellarator and magnetic-confinement foundations}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}

\begin{overviewbox}
\textbf{Curriculum scaffold - not yet a completed textbook chapter.} This file reserves the scope, learning sequence, and advanced-module connections for Basics 61. The completed version will begin from first principles, derive its central equations, include physical intuition and worked examples, and connect each derivation to numerical implementation. No placeholder statement in this scaffold should be cited as a finished derivation.
\end{overviewbox}
...
\item Toroidal angles.
\item Poloidal angles.
\item Flux coordinates.
\item Magnetic surfaces.
\item Normalized flux.
\item Rotational transform.
\item Safety factor.
\item Field-line equations.
...
\item \textbf{Chapter 1: Toroidal angles.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Poloidal angles.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Flux coordinates.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Magnetic surfaces.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Normalized flux.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Rotational transform.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Safety factor.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 8: Field-line equations.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_61_toroidal_coordinates_and_magnetic_surfaces.tex}\\
\path{basics_61_toroidal_coordinates_and_magnetic_surfaces.pdf}
\end{center}
