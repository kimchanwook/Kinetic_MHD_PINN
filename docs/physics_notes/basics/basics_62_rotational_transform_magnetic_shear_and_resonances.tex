...
\rhead{Basics 62 Course Note}

\begin{document}
\DocTitle{Basics 62: Rotational Transform, Magnetic Shear, and Resonances}{VIII - Stellarator and magnetic-confinement foundations}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}

\begin{overviewbox}
\textbf{Curriculum scaffold - not yet a completed textbook chapter.} This file reserves the scope, learning sequence, and advanced-module connections for Basics 62. The completed version will begin from first principles, derive its central equations, include physical intuition and worked examples, and connect each derivation to numerical implementation. No placeholder statement in this scaffold should be cited as a finished derivation.
\end{overviewbox}
...
\item Magnetic shear.
\item Mode localization.
\item Field-line resonance.
...
\item \textbf{Chapter 1: Rotational transform.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Safety factor.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Rational surfaces.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Magnetic shear.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Mode localization.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Field-line resonance.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Profile effects.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_62_rotational_transform_magnetic_shear_and_resonances.tex}\\
\path{basics_62_rotational_transform_magnetic_shear_and_resonances.pdf}
\end{center}
