...
\rhead{Basics 64 Course Note}

\begin{document}
\DocTitle{Basics 64: Quasisymmetry and Neoclassical Confinement}{VIII - Stellarator and magnetic-confinement foundations}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}

\begin{overviewbox}
\textbf{Curriculum scaffold - not yet a completed textbook chapter.} This file reserves the scope, learning sequence, and advanced-module connections for Basics 64. The completed version will begin from first principles, derive its central equations, include physical intuition and worked examples, and connect each derivation to numerical implementation. No placeholder statement in this scaffold should be cited as a finished derivation.
\end{overviewbox}
...
\item Quasi-axisymmetry.
\item Quasi-helical symmetry.
\item Approximate invariants.
\item Trapped-particle transport.
\item Neoclassical losses.
...
\item \textbf{Chapter 1: Quasi-axisymmetry.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Quasi-helical symmetry.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Approximate invariants.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Trapped-particle transport.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Neoclassical losses.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Optimization objectives.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_64_quasisymmetry_and_neoclassical_confinement.tex}\\
\path{basics_64_quasisymmetry_and_neoclassical_confinement.pdf}
\end{center}
