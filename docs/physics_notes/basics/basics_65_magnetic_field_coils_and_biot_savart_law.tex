...
\rhead{Basics 65 Course Note}

\begin{document}
\DocTitle{Basics 65: Magnetic-Field Coils and the Biot-Savart Law}{VIII - Stellarator and magnetic-confinement foundations}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}

\begin{overviewbox}
\textbf{Curriculum scaffold - not yet a completed textbook chapter.} This file reserves the scope, learning sequence, and advanced-module connections for Basics 65. The completed version will begin from first principles, derive its central equations, include physical intuition and worked examples, and connect each derivation to numerical implementation. No placeholder statement in this scaffold should be cited as a finished derivation.
\end{overviewbox}
...
\item Biot-savart integration.
\item Coil curves.
\item Discretization.
\item Field sensitivities.
\item Forces.
...
\item \textbf{Chapter 1: Current elements.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Biot-savart integration.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Coil curves.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Discretization.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Field sensitivities.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Forces.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Engineering constraints.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_65_magnetic_field_coils_and_biot_savart_law.tex}\\
\path{basics_65_magnetic_field_coils_and_biot_savart_law.pdf}
\end{center}
