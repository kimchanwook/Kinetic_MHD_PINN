...
\rhead{Basics 69 Course Note}

\begin{document}
\DocTitle{Basics 69: Finite-Volume Methods}{IX - Computational physics methods}{Planned textbook-style prerequisite note for the Kinetic MHD-PINN computational-plasma-physics curriculum}
...
\item Integral conservation.
\item Control volumes.
\item Cell-centered variables.
\item Face fluxes.
\item Conservative discretization.
\item Boundary fluxes.
\item Module 4 radial operator.
...
\item \textbf{Chapter 1: Integral conservation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Control volumes.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Cell-centered variables.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Face fluxes.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Conservative discretization.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Boundary fluxes.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Module 4 radial operator.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_69_finite_volume_methods.tex}\\
\path{basics_69_finite_volume_methods.pdf}
\end{center}
