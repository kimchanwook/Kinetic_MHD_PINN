...
\item Euler and runge-kutta integration.
\item Boris pusher.
\item Guiding-center integration.
\item Symplectic methods.
\item Invariant preservation.
\item Time-step selection.
...
\item \textbf{Chapter 1: Euler and runge-kutta integration.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Boris pusher.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Guiding-center integration.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Symplectic methods.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Invariant preservation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Time-step selection.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_74_particle_pushers.tex}\\
\path{basics_74_particle_pushers.pdf}
\end{center}
