...
\item Monolithic solves.
\item Partitioned solves.
\item Explicit exchange.
\item Implicit exchange.
\item Jacobi ordering.
\item Gauss-seidel ordering.
\item Loose and strong coupling.
...
\item \textbf{Chapter 1: Monolithic solves.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Partitioned solves.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Explicit exchange.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Implicit exchange.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Jacobi ordering.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Gauss-seidel ordering.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Loose and strong coupling.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_81_explicit_implicit_and_partitioned_coupling.tex}\\
\path{basics_81_explicit_implicit_and_partitioned_coupling.pdf}
\end{center}
