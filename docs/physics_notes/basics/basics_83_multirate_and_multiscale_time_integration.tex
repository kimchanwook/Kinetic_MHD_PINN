...
\item Wave timescales.
\item Gyro and orbit timescales.
\item Slowing-down time.
\item Transport time.
\item Profile-evolution time.
\item Subcycling.
\item Nested integration.
...
\item \textbf{Chapter 1: Wave timescales.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Gyro and orbit timescales.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Slowing-down time.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Transport time.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Profile-evolution time.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Subcycling.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Nested integration.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_83_multirate_and_multiscale_time_integration.tex}\\
\path{basics_83_multirate_and_multiscale_time_integration.pdf}
\end{center}
