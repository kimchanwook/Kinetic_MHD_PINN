...
\item Physical causality.
\item Feedback loops.
\item Strongly connected components.
\item Update order.
\item Solver scheduling.
...
\item \textbf{Chapter 1: Directed graphs.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Physical causality.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Feedback loops.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Strongly connected components.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Update order.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Solver scheduling.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Admissibility constraints.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_85_dependency_graphs_and_coupling_sequence.tex}\\
\path{basics_85_dependency_graphs_and_coupling_sequence.pdf}
\end{center}
