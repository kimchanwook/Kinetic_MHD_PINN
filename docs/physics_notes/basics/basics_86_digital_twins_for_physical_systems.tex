...
\item Uncertainty.
\item Scope and limitations of digital-twin claims.
...
\item \textbf{Chapter 1: Forward simulation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Reduced models.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Calibration.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Data assimilation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Real-time prediction.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\item \textbf{Chapter 7: Scope and limitations of digital-twin claims.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_86_digital_twins_for_physical_systems.tex}\\
\path{basics_86_digital_twins_for_physical_systems.pdf}
\end{center}
