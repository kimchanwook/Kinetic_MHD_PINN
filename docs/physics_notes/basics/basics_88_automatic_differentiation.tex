...
\item Symbolic versus numerical differentiation.
\item Forward mode.
\item Reverse mode.
\item Backpropagation.
\item Higher derivatives.
\item Scientific-computing implications.
...
\item \textbf{Chapter 1: Computational graphs.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Symbolic versus numerical differentiation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Forward mode.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Reverse mode.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Backpropagation.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Higher derivatives.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Scientific-computing implications.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_88_automatic_differentiation.tex}\\
\path{basics_88_automatic_differentiation.pdf}
\end{center}
