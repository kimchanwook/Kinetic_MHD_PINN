...
\item Neural solution representations.
\item Pde residual losses.
\item Collocation points.
\item Boundary losses.
\item Initial-condition losses.
\item Normalization.
\item Benchmark workflow.
...
\item \textbf{Chapter 1: Neural solution representations.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Pde residual losses.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Collocation points.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Boundary losses.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Initial-condition losses.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Normalization.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Benchmark workflow.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_89_physics_informed_neural_networks.tex}\\
\path{basics_89_physics_informed_neural_networks.pdf}
\end{center}
