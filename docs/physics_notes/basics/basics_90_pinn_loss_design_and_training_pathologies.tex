...
\item Loss imbalance.
\item Gradient imbalance.
\item Spectral bias.
\item Stiffness.
\item Trivial solutions.
\item Adaptive weights.
\item Curriculum training.
\item Causal training.
...
\item \textbf{Chapter 1: Loss imbalance.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Gradient imbalance.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Spectral bias.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Stiffness.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Trivial solutions.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Adaptive weights.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Curriculum training.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 8: Causal training.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_90_pinn_loss_design_and_training_pathologies.tex}\\
\path{basics_90_pinn_loss_design_and_training_pathologies.pdf}
\end{center}
