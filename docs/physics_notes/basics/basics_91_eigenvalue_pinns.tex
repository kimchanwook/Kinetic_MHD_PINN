...
\item Trainable eigenvalues.
\item Differential residuals.
\item Boundary constraints.
\item Normalization.
\item Orthogonality.
\item Mode collapse.
\item Comparison with matrix eigensolvers.
...
\item \textbf{Chapter 1: Trainable eigenvalues.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Differential residuals.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Boundary constraints.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Normalization.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Orthogonality.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Mode collapse.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 7: Comparison with matrix eigensolvers.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_91_eigenvalue_pinns.tex}\\
\path{basics_91_eigenvalue_pinns.pdf}
\end{center}
