...
\item Solution maps.
\item Parametric pdes.
\item Deeponet.
\item Fourier neural operators.
\item Physics-informed neural operators.
\item Generalization across functions.
...
\item \textbf{Chapter 1: Solution maps.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Parametric pdes.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Deeponet.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Fourier neural operators.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Physics-informed neural operators.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 6: Generalization across functions.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_92_operator_learning.tex}\\
\path{basics_92_operator_learning.pdf}
\end{center}
