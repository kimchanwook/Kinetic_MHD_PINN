...
\item Structure-preserving learning.
\item Long-time trajectory prediction.
...
\item \textbf{Chapter 1: Hamiltonian mechanics.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Symplectic structure.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Conserved quantities.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Structure-preserving learning.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Long-time trajectory prediction.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_93_hamiltonian_and_symplectic_neural_networks.tex}\\
\path{basics_93_hamiltonian_and_symplectic_neural_networks.pdf}
\end{center}
