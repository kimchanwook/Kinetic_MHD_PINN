...
\item Coupling-strength prediction.
\item Update-order prediction.
\item Convergence surrogates.
\item Reduced interaction models.
\item Graph-conditioned solvers.
...
\item \textbf{Chapter 1: Coupling-strength prediction.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 2: Update-order prediction.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 3: Convergence surrogates.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 4: Reduced interaction models.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
\item \textbf{Chapter 5: Graph-conditioned solvers.} Definitions, physical interpretation, derivations, worked examples, and computational implications will be developed.
...
\begin{center}
\path{basics_99_gnns_for_multiphysics_coupling.tex}\\
\path{basics_99_gnns_for_multiphysics_coupling.pdf}
\end{center}
